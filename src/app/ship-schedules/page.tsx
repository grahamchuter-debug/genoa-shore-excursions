...
export const metadata = buildMetadata({
  title: "Italian Riviera Cruise Ship Schedules",
  description:
    "Genoa cruise ship schedules by year and month. See which ships call at Genoa port before booking shore excursions, Portofino day trips or Camogli tours.",
  path,
  keywords: ["Genoa cruise ship schedule", "Genoa cruise calendar", "Genoa ship schedule"],
});
...
export default function ShipSchedulesPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Italian Riviera Cruise Ship Schedules", description: "Italian Riviera cruise ship schedules by year and month.", path })]} />
      <PageHero title="Italian Riviera Cruise Ship Schedules" subtitle="See which ships are in port before you book Riviera excursions. Times and berths are indicative — always confirm with your cruise line." compact />
