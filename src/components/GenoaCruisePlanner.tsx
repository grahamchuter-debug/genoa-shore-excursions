...
export function GenoaCruisePlanner() {
  ...
  function downloadPdf() {
    ...
    doc.save("italian-riviera-cruise-plan.pdf");
  }
  ...
  return (
    <div className="card-feature">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <button type="button" onClick={generate} className="btn-primary">Build my Riviera plan</button>
      ...
      {plan && (
        <div className="mt-8 space-y-8">
          ...
          <p className="text-xs text-gray-500">Guidance is indicative — always confirm your ship&apos;s all-aboard time and build a 60–90 minute return buffer. Summer coastal road traffic from Portofino can add 20–30 minutes.</p>
        </div>
      )}
    </div>
  );
