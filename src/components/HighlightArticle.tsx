...
export function HighlightArticle({ page }: { page: AttractionPage }) {
  ...
  return (
    <>
      ...
      />
      <PhotoHeroBand image={image} eyebrow="From Genoa Cruise Port" title={page.title} subtitle={page.tagline} compact />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {(page.slug === "portofino-from-genoa" || page.slug === "camogli-from-genoa") && (
            <SignatureExperienceCallout
              context={page.slug === "portofino-from-genoa" ? "portofino" : "camogli"}
            />
          )}
          ...
          <div className="mt-12">
            <FAQSection faqs={page.faqs} title={`${page.attractionName} from Genoa — FAQs`} />
          </div>
          <div className="mt-12">
            <PlanningLinks />
          </div>
